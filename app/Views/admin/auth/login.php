...
<head>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="<?= base_url() ?>/template/back-end/node_modules/bootstrap-social/bootstrap-social.css">
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="<?= base_url() ?>/template/back-end/assets/img/stisla-fill.svg" alt="logo" width="80" class="shadow-light rounded-circle mb-5 mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background=".<?= base_url() ?>/template/back-end/assets/img/unsplash/login-bg.jpg">

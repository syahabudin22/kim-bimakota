             ...
             <div class="col-12">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <form action="<?= site_url('admin/galeri/folder_foto/update/' . $folder_foto['folder_photoid']) ?>" method="post" enctype="multipart/form-data" autocomplete="off">
                             <?= csrf_field() ?>
                             <div class="form-group row mb-4">
                                 <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Folder</label>
                                 <div class="col-sm-12 col-md-7">
                                     <input type="text" name="folder_photo_title" class="form-control <?= isset($errors['folder_photo_title']) ? 'is-invalid' : null ?>" value="<?= old('folder_photo_title', $folder_foto['folder_photo_title']); ?>">
                             ...
                             <div class="form-group row mb-4">
                                 ...
                                 <div class="col-sm-2">
                                     <?php if ($folder_foto['folder_photo_img'] != '') : ?>
                                         <img src="<?= base_url('upload/image/galeri/foto_utama/' . $folder_foto['folder_photo_img']) ?>" class="img-thumbnail" alt="...">
                                     <?php endif; ?>
                                 </div>

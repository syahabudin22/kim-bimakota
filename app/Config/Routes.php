...
$routes->get('/admin/berita/edit_berita/(:any)', 'Berita::edit_berita/$1');
$routes->post('/admin/berita/update_berita/(:any)', 'Berita::update_berita/$1');
$routes->delete('/admin/berita/hapus_berita/(:any)', 'Berita::hapus_berita/$1');
